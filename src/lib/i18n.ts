...
const HOME_COPY: Record<Locale, HomeCopy> = {
  en: {
    ...
    historyTitle: "22 editions · 8 champions · legendary records",
    historyDesc:
  ...
  es: {
    ...
    historyTitle: "22 ediciones · 8 campeones · récords legendarios",
    historyDesc:
      "Explora cada campeón del Mundial, finales, Balones de Oro, récords históricos y controversias documentadas.",
    browseHistory: "Ver historia",
  ...
  fr: {
    ...
    worldCupHistory: "Histoire de la Coupe du monde",
    historyTitle: "22 éditions · 8 champions · records légendaires",
    historyDesc:
      "Explorez chaque vainqueur, finale, Ballons d'Or, records historiques et controverses documentées.",
    browseHistory: "Parcourir l'histoire",
