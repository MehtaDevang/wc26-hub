...
export const QUICK_NAV: SearchItem[] = [
  ...
  { id: "scenarios", label: "Qualification scenarios", href: "/scenarios", group: "Tools", keywords: "qualify advance points" },
  ...
  { id: "history", label: "World Cup history", href: "/history", group: "Explore", keywords: "winners records" },
